...
// ANSWER: set i < 5 instead of numbers.length the time complexity would be O(1)
...
// ANSWER: remove numbers2 array and change let squaredValue = numbers[i] * numbers[i]
...
// ANSWER: countLetters has a for each loop O(n) and countLettersRoundTwo has a for loop with i < str.length with space complexity O(n)
